...
namespace Cedar.WebPortal.Common
{
    ...
    public class NationalNo : RequiredAttribute, IClientValidatable
    {
            ...
            return new[]
                       {
                           new ModelClientValidationRule
                               {
                                   ValidationType = "nationalno",
                                   ErrorMessage =  ValidationResource.ResourceManager.GetString("nationalno")
                               }
                       };
        }
