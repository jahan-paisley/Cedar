			...
			<body link="#0c0000" vlink="#050000">
				<table border="1" bgcolor="#ffffff" cellspacing="0" cellpadding="0" id="CTRL1">
					<colgroup>
						...
						<col style="WIDTH: 2.7708in"/>
						<col style="WIDTH: 1.6041in"/>
						<col style="WIDTH: 2.4062in"/>
					...
					<tbody>
						<tr>
							...
							<td>
								<div align="center">
									<strong>ExperiencePerYear</strong>
								</div>
							</td>
						</tr>
					</tbody>
					<tbody id="CTRL2">
						<xsl:for-each select="JobPosition">
							...
							<tr>
								...
								<td>
									<xsl:value-of select="ExperiencePerYear"/>
								</td>
							</tr>
						</xsl:for-each>
					</tbody>
