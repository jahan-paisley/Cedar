namespace Cedar.WebPortal.WebMVC4.Helpers
{
    ...
    public static class HtmlHelperExtensionsForAttachment
    {
        ...
        public static MvcHtmlString Attachment<TItem>(this HtmlHelper<TItem> htmlHelper, Attachment expression)
            where TItem : class
        {
            ...
            if (attachment.IsNotNull())
            {
                ...
                if (routeValueDictionary.ContainsValue("Home"))
                {
                    return
                        htmlHelper.Image(
        ...
        public static MvcHtmlString DisplayAttachment<TItem>(
            this HtmlHelper<TItem> htmlHelper, Expression<Func<TItem, Attachment>> expression)
        {
            string propname = htmlHelper.ViewData.Model.Item(expression);
